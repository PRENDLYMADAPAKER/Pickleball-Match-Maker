...
// Direct client configuration using env variables (or static fallback values)
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "AIzaSyDAtr2j0iQkaPuYLcqJhIw1IqfsyCCLUUY",
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "picklequeue.firebaseapp.com",
  databaseURL: process.env.NEXT_PUBLIC_FIREBASE_DATABASE_URL || "https://picklequeue-default-rtdb.asia-southeast1.firebasedatabase.app",
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "picklequeue",
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "picklequeue.firebasestorage.app",
  messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "663355197557",
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:663355197557:web:4c2abd694e26fd2d939f3c",
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-8YZC5R007M"
};
...
async function setupViewerMode() {
  ...
  document.getElementById('displaySessionTitle').textContent = "Connecting to Next.js Session...";
